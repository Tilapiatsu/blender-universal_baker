...
class CageObjectService:
    ...
    @staticmethod
    def _ensure_cage_transform(cage: bpy.types.Object, target: bpy.types.Object) -> None:
        cage.location = target.location
        cage.rotation_euler = target.rotation_euler
        cage.scale = target.scale
